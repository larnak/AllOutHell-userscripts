    ...
    function getMapDataForSuburb(suburb) {
        ...
        switch (suburb) {
            ...
            return [
                ...
                [{type: 'street', name: 'Combs Street'}, {type: 'stadium', name: 'Landis Stadium Gift Shop'}, {type: 'stadium', name: 'Landis Stadium Gates'}, {type: 'stadium', name: 'Landis Stadium Concessions'}, {type: 'club', name: 'Night of the Stormrider'}, {type: 'parktopleft', name: 'Murphy Park'}, {type: 'parktopright', name: 'Murphy Park'}, {type: 'club', name: 'Stoneman Arcade'}, {type: 'street', name: 'Saxon Street'}, {type: 'cops', name: 'Yelchin Police Department'}],
        ...
        case 'Mulston':
                return [
                    ...
                    [{type: 'work', name: 'Work site'}, {type: 'parking', name: 'Parking Lot'}, {type: 'waste', name: 'Junkyard'}, {type: 'home', name: 'Ashford Court'}, {type: 'suicide', name: 'Prism Tower'}, {type: 'game', name: '8-it Blitz'}, {type: 'powersub', name: 'Mulston Power Relay'}, {type: 'cops', name: 'Mulston PD'}, {type: 'store', name: "Pop's Video Rental"}, {type: 'bar', name: 'The Burchell'}],
